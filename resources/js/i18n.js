...
(function () {
    const translations = {
        ko: {
            ...
            hero_title: "수천억 대 부동산 자산,<br/>DX를 넘어 AX 기반으로 관리하십시오",
        ...
        en: {
            ...
            hero_title: "Beyond DX to AX: Intelligent Asset Management<br/>for Hundreds of Billions in Real Estate",
        ...
        ja: {
            ...
            hero_title: "数百億円規模の不動産資産、<br/>DXを超えAX基盤で管理せよ",
        ...
        zh: {
            ...
            hero_title: "千亿级房地产资产，<br/>跨越DX、基于AX智能管理",
